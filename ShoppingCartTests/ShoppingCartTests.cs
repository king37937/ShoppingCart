...
namespace ShoppingCart.Tests
{
    ...
    public class ShoppingCartTests
    {
        ...
        [TestMethod()]
        public void CalculatePriceTest_Id_1_Quantity_1_Id_2_Quantity_2_Id_3_Quantity_1_should_return_270m()
        {
            //arrange
            var target = new ShoppingCart();
            var books = new List<Book>
        ...
        [TestMethod()]
        public void CalculatePriceTest_Id_1_Quantity_1_Id_2_Quantity_2_Id_3_Quantity_1_Id_4_Quantity_1_should_return_320m()
        {
            //arrange
            var target = new ShoppingCart();
            var books = new List<Book>
